...
#define FEIYU_CONTRACT_INDEX 13
#define CONTRACT_INDEX FEIYU_CONTRACT_INDEX
#define CONTRACT_STATE_TYPE FEIYU
#define CONTRACT_STATE2_TYPE FEIYU2
#include "contracts/Feiyu.h"
...
static void initializeContracts()
{
    ...
    REGISTER_CONTRACT_FUNCTIONS_AND_PROCEDURES(FEIYU);
    // new contracts should be added above this line
#ifdef INCLUDE_CONTRACT_TEST_EXAMPLES
